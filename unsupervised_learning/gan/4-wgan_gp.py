#!/usr/bin/env python3
"""
Wasserstein GAN with Gradient Penalty (WGAN-GP) module with weight reloading
"""
...
class WGAN_GP(keras.Model):
    """
    WGAN with Gradient Penalty class inheriting from keras.Model
    """
    ...
    def train_step(self, useless_argument):
        """
        Performs one training step of WGAN-GP
        """
